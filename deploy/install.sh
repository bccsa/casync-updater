...
echo -e "${NC}"
wget -O /etc/casync-updater/default.json https://github.com/bccsa/casync-updater/raw/main/deploy/default.json
...
echo ''
echo -e "${NC}"
casync extract --with=2sec-time --store=https://bccsa.github.io/casync-updater/store.castr https://bccsa.github.io/casync-updater/index.caidx /opt/casync-updater/
...
echo 'Add your own casync configuration files to /etc/casync-updater (see https://github.com/bccsa/casync-updater for detailed instructions).'
